...
exports.makeEditable = function () {
    terminal.setBackground(ansi.colors.BLACK);
    terminal.setForeground(ansi.colors.CYAN);
    ...
    dispatcher.on(ansi.keys.PAGEUP, pageup);
    dispatcher.on(ansi.keys.PAGEDOWN, pagedown);
